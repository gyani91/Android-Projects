...
public class SpeedTestLauncher extends Activity {
	...
	private final Handler mHandler=new Handler(){
		...
		public void handleMessage(final Message msg) {
			...
			case MSG_COMPLETE_STATUS:
				...
				mTxtSpeed.setText(String.format(getResources().getString(R.string.update_downloaded_complete), info2.downspeed));
				
				mTxtProgress.setText(String.format(getResources().getString(R.string.update_downloaded), msg.arg1, EXPECTED_SIZE_IN_BYTES));
				
				if(networkType(info2.downspeed)==1)
				{
	...
	private final Runnable mWorker=new Runnable(){
		...
		public void run() {
			...
			try {
				int bytesIn=0;
				String downloadFileUrl="http://web.mit.edu/bentley/www/papers/a30-bentley.pdf";	
	...
	private static final int EXPECTED_SIZE_IN_BYTES = 7710183;//1MB 1024*1024
